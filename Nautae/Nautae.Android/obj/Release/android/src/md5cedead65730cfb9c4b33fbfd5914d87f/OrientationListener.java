...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Xna.Framework.OrientationListener, MonoGame.Framework, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", OrientationListener.class, __md_methods);
	}
	...
	public OrientationListener (android.content.Context p0, int p1) throws java.lang.Throwable
	{
		...
		if (getClass () == OrientationListener.class)
			mono.android.TypeManager.Activate ("Microsoft.Xna.Framework.OrientationListener, MonoGame.Framework, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Hardware.SensorDelay, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}
